<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="RequestLogin.aspx.cs" Inherits="Assignment06.WebForm2" %>
    ...
    <div class="container">
        <div id="mainform">
            ...
            <div class="row formrow justify-content-center">
                <asp:Button CssClass="" ID="RegisterButton" runat="server" Text="Register" UseSubmitBehavior="False" Class="FormButton" OnClick="RegisterButon"  />
            </div>
            <div class="row formrow justify-content-center">
            <asp:Label CssClass="" ID="Label1" runat="server"></asp:Label>
            </div>
        </div>
    </div>
